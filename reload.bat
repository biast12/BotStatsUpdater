...
REM ============================================
REM   BotStatsUpdater Reload Script
REM   Recreates containers from existing image (no rebuild)
REM ============================================

title BotStatsUpdater - Reloading...
...
REM Recreate containers from existing image (no rebuild)
echo Reloading BotStatsUpdater containers...
title BotStatsUpdater - Reloading Containers...

docker compose up -d --force-recreate --remove-orphans %*
if errorlevel 1 (
    echo ERROR: Docker Compose failed to reload containers
    goto :error_exit
)
...
title BotStatsUpdater - Reload Complete!
echo Reload completed successfully!
goto :end

:error_exit
title BotStatsUpdater - Reload Failed!
echo Reload failed.
